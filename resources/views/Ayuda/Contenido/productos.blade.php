		...
		<div class="x_panel">
			...
			<div class="tab-content" id="myTabContent">
				...
				<div class="tab-pane fade show active" id="one" role="tabpanel" aria-labelledby="one-tab">
					...
					<iframe src={{asset('help/productos/NuevoProducto/NuevoProducto_player.html')}} frameborder="0" scrolling="no" width="100%" height="430px"></iframe>
				</div>
				...
				<div class="tab-pane fade" id="two" role="tabpanel" aria-labelledby="two-tab">
					...
					<iframe src={{asset('help/productos/EditarProducto/EditarProducto_player.html')}} frameborder="0" scrolling="no" width="100%" height="430px"></iframe>
				</div>				
